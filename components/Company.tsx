      ...
      <div className="container empresa-grid">
        <div className="empresa-images reveal reveal-left">
          <div className="img-large">
            <Image src="/images/sections/empresa/transfribol-history.png" alt="Camion Transfribol en ruta de montaña" width={500} height={350} className="rounded shadow" />
          </div>
          <div className="img-small">
            <Image src="/images/sections/empresa/transfribol-team.jpg" alt="Camiones Transfribol" width={400} height={300} className="rounded shadow" />
          </div>
        </div>
